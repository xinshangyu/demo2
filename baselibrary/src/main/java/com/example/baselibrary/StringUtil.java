...
public class StringUtil {
    ...
    public static boolean isEmpty(String str) {
        ...
        return null == str ||"null" == str || "".equals(str) || str.length() == 0 ? true
                : false;
    }
    ...
    public static boolean isCellPhone(String str) {
        ...
        boolean b = false;
        p = Pattern
                .compile("^((1[83][0-9])|(14[57])|(17[035678])|(15[012356789])|(166)|(19[89]))\\d{8}$"); // 验证手机号
        m = p.matcher(str);
        b = m.matches();
        return b;
    }
...
//        }
        //小写字母和数字
        if (pass.matches(".*[a-z]{1,}.*") && pass.matches(".*\\d{1,}.*")) {
            return true;

        }
        //小写字母和符号
        if (pass.matches(".*[a-z]{1,}.*") && pass.matches(".*[~!@#$%^&*\\.?]{1,}.*")) {
        ...
        //数字和符号
        if (pass.matches(".*\\d{1,}.*") && pass.matches(".*[~!@#$%^&*\\.?]{1,}.*")) {
