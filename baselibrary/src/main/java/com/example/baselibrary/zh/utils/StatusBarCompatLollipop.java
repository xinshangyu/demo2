...
class StatusBarCompatLollipop {
     ...
     * 2. cancel CollapsingToolbarLayout's WindowInsets, let it layout as banner_normal(now setStatusBarScrimColor is useless).
     * 3. set View's FitsSystemWindow to false.
     * 4. add Toolbar's height, let it layout from top, then add paddingTop to layout banner_normal.
