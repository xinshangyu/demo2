...
public class ApiKeys {
    ...
    public static final String API_DEVELOPMENT_DOMAIN3 = "http://192.168.0.195:9993/";//内网
    ...
    public static final String API_DEVELOPMENT_URL2 = API_DEVELOPMENT_DOMAIN2 + "";//项目名
    public static final String API_DEVELOPMENT_URL3 = API_DEVELOPMENT_DOMAIN3 + "";//项目名
